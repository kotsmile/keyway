...
//
// The directory is cmd/cli; the binary it builds is `keyway` (go build -o
// keyway ./cmd/cli) — the name people type at a shell.
package main
...
import (
	...
	"github.com/kotsmile/keyway/cmd/cli/internal/output"
	"github.com/kotsmile/keyway/cmd/cli/internal/profile"
	"github.com/kotsmile/keyway/cmd/cli/internal/wire"
)

// version follows the release tags; it carried the Cargo workspace's number
// over at the cutover so the lineage stays one sequence.
const version = "0.1.0"
