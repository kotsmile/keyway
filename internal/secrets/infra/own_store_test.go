...
func ownStore(t *testing.T, db *sqlx.DB, active string, keys map[string]string) *secretsservice.OwnStoreService {
	t.Helper()
...
// must not compile.
var _ entity.SecretManager = (*secretsservice.OwnStoreService)(nil)
