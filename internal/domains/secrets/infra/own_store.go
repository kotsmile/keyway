...
// ListSecrets implements secrets.OwnStoreRepo.
...
// GetSecret implements secrets.OwnStoreRepo.
...
// InsertSecret implements secrets.OwnStoreRepo.
...
// UpdateLabels implements secrets.OwnStoreRepo.
...
// DeleteSecret implements secrets.OwnStoreRepo.
...
// ListVersions implements secrets.OwnStoreRepo.
...
// GetVersion implements secrets.OwnStoreRepo.
...
// AppendVersion implements secrets.OwnStoreRepo.
func (r *PostgresOwnStoreRepo) AppendVersion(ctx context.Context, store, name string, seal secrets.SealWith) (entity.OwnVersion, error) {
...
// KeyIDsInUse implements secrets.OwnStoreRepo.
...
var _ secrets.OwnStoreRepo = (*PostgresOwnStoreRepo)(nil)
